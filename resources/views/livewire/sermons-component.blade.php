<!-- Page info section -->
<section class="page-info-section set-bg" data-setbg="{{ asset('img/bg.jpg') }}">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="sermon-item">
                    <div class="si-thumb set-bg" data-setbg="{{ asset('img/sermons/1.jpg') }}"></div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="sermon-item">
                    <div class="si-thumb set-bg" data-setbg="{{ asset('img/sermons/2.jpg') }}"></div>
                    <div class="si-content">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="sermon-item">
                    <div class="si-thumb set-bg" data-setbg="{{ asset('img/sermons/3.jpg') }}"></div>
                    <div class="si-content">
                        <h4>I Will Be Gracious to Whom I Will Be Gracious</h4>
                        <ul class="sermon-info">
                            <li>Sermon From: <span>Vincent John</span></li>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="sermon-item">
                    <div class="si-thumb set-bg" data-setbg="{{ asset('img/sermons/4.jpg') }}"></div>
                    <div class="si-content">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="sermon-item">
                    <div class="si-thumb set-bg" data-setbg="{{ asset('img/sermons/5.jpg') }}"></div>
                    <div class="si-content">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="sermon-item">
                    <div class="si-thumb set-bg" data-setbg="{{asset('img/sermons/6.jpg') }}"></div>
                    <div class="si-content">
